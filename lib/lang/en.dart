const Map<String, String> EN_LANG = {
  ...
  'ownerIsMulti':
      "The current miner's owner is a multi-sign account. Please  go to the multi-sign page",
  ...
  'ChangeWorkerAddress': 'Change worker address',
  'ChangeOwnerAddress': 'Change owner address',
  'ConfirmUpdateWorkerKey': 'ConfirmUpdateWorkerKey',
  'withdrawNum': 'Withdraw Amount',
  'newOwner': 'New owner',
  'oldOwner': "Original miner",
  'searchOwnerFail': 'search owner id fail',
  'minerManageTip':
      'In order to ensure the safety of nodes, miner management is only operated offline',
  'opOption': 'Operation options',
  'minerNotExist': 'search miner failed, please check',
