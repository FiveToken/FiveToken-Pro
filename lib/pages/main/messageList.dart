...
class CommonOnlineWallet extends StatefulWidget {
  ...
  CommonOnlineWallet({this.address});
  @override
...
class CommonOnlineWidgetState extends State<CommonOnlineWallet>
  ...
  @override
  void didUpdateWidget(covariant CommonOnlineWallet oldWidget) {
    ...
    try {
      ...
      if (res.isNotEmpty) {
        ...
        for (var i = 0; i < messages.length; i++) {
          var m = messages[i];
          if (ValidMethods.contains(m.methodName)) {
...
class MessageItem extends StatelessWidget {
  ...
  bool get isWithdraw {
    return mes.methodName == 'WithdrawBalance';
  }
